...
from semblock.llama_model import llama_flash_attn2_forward_PyramidKV,llama_flash_attn2_forward_SemBlock,llama_flash_attn2_forward_H2O,llama_flash_attn2_forward_SnapKV,llama_flash_attn2_forward_StreamingLLM, llama_flash_attn2_forward_SentenceKV,llama_flash_attn2_forward_ChunkKV
from semblock.llama_model import llama_attn_forward_PyramidKV,llama_attn_forward_SemBlock,llama_attn_forward_H2O,llama_attn_forward_SnapKV,llama_attn_forward_StreamingLLM, llama_attn_forward_SentenceKV,llama_attn_forward_ChunkKV
from semblock.llama_model import llama_sdpa_attn_forward_PyramidKV,llama_sdpa_attn_forward_SemBlock,llama_sdpa_attn_forward_H2O,llama_sdpa_attn_forward_SnapKV,llama_sdpa_attn_forward_StreamingLLM, llama_sdpa_attn_forward_SentenceKV,llama_sdpa_attn_forward_ChunkKV
from semblock.llama_model import adaptive_LlamaModel_forward

from semblock.mistral_model import mistral_flash_attn2_forward_PyramidKV,mistral_flash_attn2_forward_SemBlock,mistral_flash_attn2_forward_H2O,mistral_flash_attn2_forward_SnapKV,mistral_flash_attn2_forward_StreamingLLM,mistral_flash_attn2_forward_SentenceKV,mistral_flash_attn2_forward_ChunkKV
from semblock.mistral_model import mistral_attn_forward_PyramidKV,mistral_attn_forward_SemBlock,mistral_attn_forward_H2O,mistral_attn_forward_SnapKV,mistral_attn_forward_StreamingLLM,mistral_attn_forward_SentenceKV,mistral_attn_forward_ChunkKV
from semblock.mistral_model import mistral_sdpa_attn_forward_PyramidKV,mistral_sdpa_attn_forward_SemBlock,mistral_sdpa_attn_forward_H2O,mistral_sdpa_attn_forward_SnapKV,mistral_sdpa_attn_forward_StreamingLLM, mistral_sdpa_attn_forward_SentenceKV,mistral_sdpa_attn_forward_ChunkKV
...
def replace_llama(method, model_name=None):
    ...
    elif method == "sentencekv":
        print("Using SentenceKV!")
        transformers.models.llama.modeling_llama.LlamaAttention.forward = llama_attn_forward_SentenceKV
        transformers.models.llama.modeling_llama.LlamaFlashAttention2.forward = llama_flash_attn2_forward_SentenceKV
        transformers.models.llama.modeling_llama.LlamaSdpaAttention.forward = llama_sdpa_attn_forward_SentenceKV

    elif method == "chunkkv":
        print("Using ChunkKV!")
        transformers.models.llama.modeling_llama.LlamaAttention.forward = llama_attn_forward_ChunkKV
        transformers.models.llama.modeling_llama.LlamaFlashAttention2.forward = llama_flash_attn2_forward_ChunkKV
        transformers.models.llama.modeling_llama.LlamaSdpaAttention.forward = llama_sdpa_attn_forward_ChunkKV
...
def replace_mistral(method):
    ...
    if method == "pyramidkv":
        ...
        print("Using SentenceKV!")
        transformers.models.mistral.modeling_mistral.MistralAttention.forward = mistral_attn_forward_SentenceKV
        transformers.models.mistral.modeling_mistral.MistralFlashAttention2.forward = mistral_flash_attn2_forward_SentenceKV
        transformers.models.mistral.modeling_mistral.MistralSdpaAttention.forward = mistral_sdpa_attn_forward_SentenceKV

    elif method == "chunkkv":
        print("Using ChunkKV!")
        transformers.models.mistral.modeling_mistral.MistralAttention.forward = mistral_attn_forward_ChunkKV
        transformers.models.mistral.modeling_mistral.MistralFlashAttention2.forward = mistral_flash_attn2_forward_ChunkKV
        transformers.models.mistral.modeling_mistral.MistralSdpaAttention.forward = mistral_sdpa_attn_forward_ChunkKV
