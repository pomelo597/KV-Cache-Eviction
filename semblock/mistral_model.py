...
from semblock.utils import init_pyramidkv, init_semblock, init_snapkv, init_H2O, init_StreamingLLM, init_sentencekv,init_chunkkv
...
def mistral_attn_forward_SentenceKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
    ...
    **kwargs,
    ...
    init_sentencekv(self, num_hidden_layers=self.config.num_hidden_layers)
...
def mistral_sdpa_attn_forward_SentenceKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
def mistral_flash_attn2_forward_SentenceKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
def mistral_attn_forward_ChunkKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
    ...
    **kwargs,
    ...
    init_chunkkv(self, num_hidden_layers=self.config.num_hidden_layers)
...
def mistral_sdpa_attn_forward_ChunkKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
def mistral_flash_attn2_forward_ChunkKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
